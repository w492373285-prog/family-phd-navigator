...
const resources = [
  ...
  { key: 'mentors', label: '导师', load: api.getMentors, save: api.saveMentor, fields: [['country', '国家'], ['school', '学校'], ['name', '导师名称'], ['research_area', '研究方向'], ['email', '邮箱'], ['profile_url', '官方主页/检索页'], ['priority', '优先级'], ['keywords', '关键词', true], ['fit_notes', '匹配说明', true], ['contact_strategy', '套磁建议', true]] },
